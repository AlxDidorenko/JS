<template>
  <div>
    <v-toolbar flat color="white">
      ...
      <v-dialog v-model="dialog" max-width="500px">
        <v-btn slot="activator" color="primary" dark class="mb-2">Add row</v-btn>
        <v-card>
          <v-card-title>
 ...
 <template slot="items" slot-scope="props">
      ...
      <td class="layout">
          <v-icon small class="mr-2" @click="Updt(props.item)">Updt</v-icon>
          <v-icon small @click="Del(props.item)">Del</v-icon>
        </td>
    </template>
